...
assert.equal(typesModule.normalizeLanguage('zh-HK'), 'zh-CN')
assert.equal(typesModule.normalizeLanguage('en-US'), 'en-US')
assert.equal(typesModule.normalizeLanguage('en'), 'en-US')
assert.equal(typesModule.normalizeLanguage('en-GB'), 'en-US')
assert.equal(typesModule.normalizeLanguage('fr-FR'), 'zh-CN')
assert.equal(typesModule.normalizeLanguage(null), 'zh-CN')
assert.equal(typesModule.matchSupportedLanguage('fr-FR'), null)
assert.equal(typesModule.matchSupportedLanguage('en-GB'), 'en-US')
assert.equal(typesModule.getSystemLanguage(['fr-FR', 'en-GB']), 'en-US')
assert.equal(typesModule.getSystemLanguage(['zh-HK', 'en-US']), 'zh-CN')
assert.equal(typesModule.getSystemLanguage(['fr-FR']), 'zh-CN')
